...
class ValidasiNilaiController extends Controller
{
     ...
     * (Data 'Pending' tidak perlu divalidasi, itu privasi Guru Mapel)
     *
    ...
    public function index()
    {
        ...
        // Pending tidak perlu ditampilkan, masih privasi guru
        $nilai = Nilai::getByStatus(
            $kelas["kelas_id"],
    ...
    public function proses()
    {
        ...
        if ($keputusan === "Final") {
            if (
                ...
                setAlert(
                    "error",
                    "Tidak bisa finalisasi: Ada nilai yang masih kosong (0)."
                );
        ...
        $result = Nilai::updateStatusWithNote(
            $nilai_id,
            $keputusan,
            $catatan_revisi
        );
        ...
        if ($result["status"]) {
            if ($keputusan === "Final") {
                ...
                $msg =
                    "Nilai ditolak (Revisi). Guru akan melihat catatan Anda.";
            }
